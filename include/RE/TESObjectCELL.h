...
namespace RE
{
	...
	public:
		...
		void           ForEachReference(std::function<bool(RE::TESObjectREFR&)> a_callback) const;
		...
		BSTempEffectParticle* PlaceParticleEffect(float a_lifetime, const char* a_modelName, const RE::NiMatrix3& a_normal, const RE::NiPoint3& a_pos, float a_scale, UInt32 a_flags, RE::NiAVObject* a_target);
