...
namespace RE
{
	...
	namespace BSScript
	{
		...
		public:
			...
			virtual void					   Unk_1C(void) = 0;																																										   // 1C - added in VR 1.4.15
			virtual void					   Unk_1D(void) = 0;																																										   // 1D - added in VR 1.4.15
			...
			virtual const ObjectBindPolicy*	   GetObjectBindPolicy2() const = 0;																																						   // 32
			virtual ISavePatcherInterface*	   GetSavePatcherInterface() = 0;																																							   // 33
			virtual void					   RegisterForLogEvent(BSTEventSink<LogEvent>* a_sink) = 0;																																	   // 34
			virtual void					   UnregisterForLogEvent(BSTEventSink<LogEvent>* a_sink) = 0;																																   // 35
			virtual void					   RegisterForStatsEvent(BSTEventSink<StatsEvent>* a_sink) = 0;																																   // 36
			virtual void					   UnregisterForStatsEvent(BSTEventSink<StatsEvent>* a_sink) = 0;																															   // 37
