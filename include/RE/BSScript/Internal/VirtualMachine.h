	...
	namespace BSScript
	{
		...
		namespace Internal
		{
			...
			public:
				...
				virtual void					   Unk_1C(void) override;																																											// 1C - added in VR 1.4.15
				virtual void					   Unk_1D(void) override;																																											// 1D - added in VR 1.4.15
				...
				virtual const ObjectBindPolicy*	   GetObjectBindPolicy2() const override;																																							// 32 - { return objectBindPolicy; }
				virtual ISavePatcherInterface*	   GetSavePatcherInterface() override;																																								// 33 - { return savePatcherInterface; }
				virtual void					   RegisterForLogEvent(BSTEventSink<LogEvent>* a_sink) override;																																	// 34
				virtual void					   UnregisterForLogEvent(BSTEventSink<LogEvent>* a_sink) override;																																	// 35
				virtual void					   RegisterForStatsEvent(BSTEventSink<StatsEvent>* a_sink) override;																																// 36
				virtual void					   UnregisterForStatsEvent(BSTEventSink<StatsEvent>* a_sink) override;																																// 37
