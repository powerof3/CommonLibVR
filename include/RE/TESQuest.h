...
namespace RE
{
	...
	public:
		...
		ObjectRefHandle&						 CreateRefHandleByAliasID(ObjectRefHandle& a_handle, UInt32 a_aliasID);
		bool									 EnsureQuestStarted(bool& a_result, bool a_startNow);
		UInt16									 GetCurrentStageID() const;
		[[nodiscard]] constexpr QUEST_DATA::Type GetType() const noexcept { return data.questType; }
		bool									 IsActive() const;
